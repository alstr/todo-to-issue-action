...
class NewIssueTests(unittest.TestCase):
    ...
    def test_zig_issues(self):
        self.assertEqual(count_issues_for_file_type(self.raw_issues, 'zig'), 3)
...
class ClosedIssueTests(unittest.TestCase):
    ...
    def test_zig_issues(self):
        self.assertEqual(count_issues_for_file_type(self.raw_issues, 'zig'), 1)
